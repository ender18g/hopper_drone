#!/usr/bin/env python3
"""Generate archived branded WRC Hopper information slide PDFs.

The source photos are re-encoded before use so no EXIF metadata is published.
Final PDFs are written only to output/pdf. The website, offline, standalone,
and Electron builds use the HTML lessons generated by
scripts/generate-information-lessons.mjs.
"""
