...
@class NSBundle;
@class NSCoder;
SWIFT_RESILIENT_CLASS("_TtC3App26HopperBridgeViewController")
@interface HopperBridgeViewController : CAPBridgeViewController
...
SWIFT_CLASS_NAMED("HopperNativePlugin")
@interface HopperNativePlugin : CAPPlugin <CAPBridgedPlugin, CBCentralManagerDelegate, CBPeripheralDelegate, NSURLSessionDataDelegate>
...
- (void)load;
- (void)requestDevice:(CAPPluginCall * _Nonnull)call;
- (void)connect:(CAPPluginCall * _Nonnull)call;
- (void)disconnect:(CAPPluginCall * _Nonnull)call;
- (void)read:(CAPPluginCall * _Nonnull)call;
- (void)write:(CAPPluginCall * _Nonnull)call;
- (void)startNotifications:(CAPPluginCall * _Nonnull)call;
- (void)checkCamera:(CAPPluginCall * _Nonnull)call;
- (void)startCamera:(CAPPluginCall * _Nonnull)call;
- (void)stopCamera:(CAPPluginCall * _Nonnull)call;
...
SWIFT_CLASS("_TtC3App13SceneDelegate")
